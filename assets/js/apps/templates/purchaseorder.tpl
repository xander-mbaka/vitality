    ...
    <div class="row">
          ...
          <div class="panel-title">
            ...
            <div class="panel-body">
              <form class="form-horizontal" id="frmi2">  
                ...
                <button type="submit" class="btn btn-default iadd">Add To Order</button>
              </form>
            </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-7">
        <div class="panel panel-default">
          ...
          <div class="panel-title">
            Order Items <span class="label label-primary">?</span>
            <ul class="panel-tools">
              <li><a class="icon minimise-tool"><i class="fa fa-minus"></i></a></li>
              <li><a class="icon expand-tool"><i class="fa fa-expand"></i></a></li>
              <li><a class="icon closed-tool"><i class="fa fa-times"></i></a></li>
          ...
          <div class="panel-body table-responsive">
            ...
            <form class="form-horizontal" style="overflow:hidden;border-top:5px solid #ddd;padding-top:20px" id="frmi3">
              ...
              <button type="submit" class="btn btn-default igenerate float-r">Generate Order</button>
            </form>
          </div>
        </div>
      </div>
