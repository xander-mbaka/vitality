...
<div id="leadscont" class="">
  ...
  <div class="page-header">
    <h1 class="title">Receive Ordered Goods & Services</h1>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form class="form-horizontal" id="frmi1">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label form-label">Order<span class="color10">*</span></label>
                <div class="col-sm-10">
                  <select class="selectpicker form-control" name="order" id="orders" data-live-search="true">
                    <option data-icon="fa fa-cubes">Select Order...</option>
                  </select>  
                </div>              
              </div>
              <div class="form-group">
          ...
          <div class="panel-title">
            ...
            <div class="panel-body">
              <form class="form-horizontal" id="frmi2">
                <div class="form-group">
                  <label class="col-sm-2 control-label form-label">Item Ordered<span class="color10">*</span></label>
                  <div class="col-sm-10">
                    <select class="selectpicker form-control" name="item" id="items" data-live-search="true" >
                      <option data-icon="fa fa-cube">Select Item...</option>
                    </select>  
                  </div>              
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label form-label">Quantity Ordered<span class="color10">*</span></label>
                  <div class="col-sm-2">
                    <input type="text" name="qty" class="form-control" id="qty" value="1" disabled>
                  </div>
                  <label class="col-sm-2 control-label form-label">Tax</label>
                  <div class="col-sm-2">
                    <input type="text" name="tax" class="form-control" id="tax" placeholder="%">
                  </div>
