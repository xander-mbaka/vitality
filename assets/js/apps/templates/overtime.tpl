...
<div id="leadscont" class="">
  ...
  <div class="page-header">
    <h1 class="title">Post Employee Overtime</h1>
            ...
            <ul class="panel-tools">
              ...
              <div class="panel-body">
                <form class="form-horizontal" id="frm1">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Hours<span class="color10">*</span></label>
                    <div class="col-sm-2">
                      <input type="text" name="hours" class="form-control" id="" value="1">
                    </div>
                    <label class="col-sm-2 control-label form-label">Rate<span class="color10">*</span></label>
                    <div class="col-sm-6">
                      <div class="input-group">
                        <div class="input-group-addon"><i class="">Ksh.</i></div>
                        <input type="text" name="rate" class="form-control" id="">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
